...
public static void main(String[] args) {
	File file1 = new File("D:\\CareerProject\\incHRM - Copy\\src");
	File file2 = new File("D:\\CareerProject\\incHRM\\src");
	assertPathEqualsRecursively(file1.toPath(), file2.toPath());
}
